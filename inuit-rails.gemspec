...
# -*- encoding: utf-8 -*-
# stub: inuit-rails 0.2.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "vendor/assets/stylesheets/inuit-tools-widths/_tools.widths.scss",
    ...
    "vendor/assets/stylesheets/wgc/_borders.scss",
    "vendor/assets/stylesheets/wgc/_colours.scss",
    "vendor/assets/stylesheets/wgc/_layout.scss",
    "vendor/assets/stylesheets/wgc/_typography.scss",
    "vendor/assets/stylesheets/wgc/inuit-overrides/_base.forms.scss",
    "vendor/assets/stylesheets/wgc/inuit-overrides/_base.headings.scss",
    "vendor/assets/stylesheets/wgc/inuit-overrides/_generic.shared.scss",
    "vendor/assets/stylesheets/wgc/inuit-overrides/_objects.flyout.scss",
    "vendor/assets/stylesheets/wgc/inuit-overrides/_objects.layout.scss",
    "vendor/assets/stylesheets/wgc/inuit-overrides/_settings.defaults.scss",
    "vendor/assets/stylesheets/wgc/inuit-overrides/_settings.responsive.scss",
    "vendor/assets/stylesheets/wgc/inuit-overrides/_tools.functions.scss",
    "vendor/assets/stylesheets/wgc/inuit-overrides/_tools.mixins.scss",
    "vendor/assets/stylesheets/wgc/inuit-overrides/_trumps.spacing-responsive.scss",
    "vendor/assets/stylesheets/wgc/inuit-overrides/_trumps.spacing.scss",
    "vendor/assets/stylesheets/wgc/inuit-overrides/_trumps.widths-responsive.scss"
  ]
